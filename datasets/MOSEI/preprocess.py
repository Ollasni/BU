...
pickle_path = "/esat/smcdata/users/kkontras/Image_Dataset/no_backup/Mosei/mosei_data_0610.pkl"
...
print(emotion_features['train'].keys())

#plot an image
import matplotlib.pyplot as plt
plt.imshow(emotion_features['train']["vision"][0])
plt.show()
