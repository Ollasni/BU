...
#                     continue
#
#         # load         open("./datasets/AVE/wav_norm.pkl", "wb").write(pickle.dumps(self.wav_norm))
...
class AVE_Dataloader():
    ...
    def __init__(self, config):
        ...
        logging.info("Train {}, Val {}, Test {}".format(len(sleep_dataset_train), len(sleep_dataset_val), len(sleep_dataset_test)))
...
class AVE_Dataloader_vit():
    ...
    def __init__(self, config):
        ...
        sleep_dataset_train.logger.info("Train {}, Val {}, Test {}".format(len(sleep_dataset_train), len(sleep_dataset_val), len(sleep_dataset_test)))
